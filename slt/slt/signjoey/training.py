...
class TrainManager:
    ...
    def _train_batch(self, batch: Batch, update: bool = True) -> (Tensor, Tensor):
        ...
        #weightloss=torch.exp(self.model.bn.a)-self.model.bn.a
        
        #logvar=self.model.bn.a
       # weightloss= -0.5 * torch.sum(1 + logvar - logvar.exp())
      # weightloss=weightloss*0.001
        ...
        kl_loss+=kls
        total_loss = normalized_recognition_loss + normalized_translation_loss+kl_loss+kls
